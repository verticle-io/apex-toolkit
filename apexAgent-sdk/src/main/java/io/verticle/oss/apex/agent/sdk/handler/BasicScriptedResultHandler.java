...
/**
 * This handler executes Groovy scripts, after method execution.
 * @author Jens Saade
 */
public class BasicScriptedResultHandler extends AbstractHandler {

    static final Logger logger = LoggerFactory.getLogger(BasicScriptedResultHandler.class);
